...
# Compiler options here. -fsingle-precision-constant -Wdouble-promotion
ifeq ($(USE_OPT),)
  USE_OPT = -O2 -ggdb -fomit-frame-pointer -falign-functions=16 -lm -fsingle-precision-constant -std=gnu11 #-gdwarf# -Wdouble-promotion
endif
